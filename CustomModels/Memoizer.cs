...
namespace MCGalaxy {
    public sealed partial class CustomModelsPlugin {
        class Memoizer1<TKey, TValue> {
            private readonly Func<TKey, TValue> fetch;
            private TimeSpan? cacheLifeTime;
            private readonly Func<Exception, TValue> exceptionHandler;
            ...
            private readonly ConcurrentDictionary<TKey, object> cacheLocks = new ConcurrentDictionary<TKey, object>();
            private object GetCacheLock(TKey key) {
                return cacheLocks.GetOrAdd(key, (_) => new object());
            }

            private readonly ConcurrentDictionary<TKey, CacheEntry> cache = new ConcurrentDictionary<TKey, CacheEntry>();
